			...
			<table class="table table-striped" style="text-align:center; border:1px solid #dddddd"> 
				<thead>
					<tr>
						...
						<th colspan="2" style="background-color: #eeeeee; text-align: center;">고객센터 문의하기</th>
					</tr>
				</thead>
				<tbody>
					...
					<!-- 글 제목을 작성할 수있는 input을 삽입 해준다. -->
						<td><input type="text" class="form-control" placeholder="작성자" name="bbsid" maxlength="10"></td>
					</tr>
					<tr>
